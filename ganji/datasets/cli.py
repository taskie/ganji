...
def main():
    ...
    parser.add_argument("--show-density", help="show density", default=False, action="store_true")
    ...
    if args.show_density:
        bitmaps = load_bitmaps(
            codepoints, [(args.font, args.font_index, args.size)], density_quantiles=density_quantiles
        )
