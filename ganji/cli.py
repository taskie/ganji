...
def main():
    ...
    new_parser.add_argument('-B', '--batch-size', type=int, help='batch_size', default=256)
    new_parser.add_argument('-C', '--codepoint-set', help='codepoint set (kanji|jouyou-kanji|hiragana) [default: kanji]', default='kanji')
    ...
    def command_generate(args):
        ganji.gan.generate(args.dir, nice=args.nice)
